...
def retrieve_timesteps(
    ...
    **kwargs,
    ...
    if timesteps is not None:
        ...
        # Dynamic shifting evaluates 1/t at the valid t=0 endpoint. NumPy
        # reports a divide-by-zero warning even though the shifted sigma is 0.
...
class ImageGenerationPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        callback_on_denoising_start: Optional[Callable[[int], None]] = None,
        ...
        # 6. Denoising loop
        if callback_on_denoising_start is not None:
            callback_on_denoising_start(len(timesteps))
