...
class family_handler:
    ...
    def query_model_def(base_model_type, model_def):
        return {
            ...
            "vae_block_size": 32,
            "sample_solvers": [("Default", "default"), ("Viggle Turbo", "viggle_v02")],
