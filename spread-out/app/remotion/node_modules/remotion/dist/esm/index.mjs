...
var SharedAudioContextProvider = ({ children, audioLatencyHint, audioEnabled }) => {
  ...
  const audioContextIsPlayingEventually = useRef8(false);
  const isResuming = useRef8(null);
  const audioSyncAnchor = useMemo18(() => ({ value: 0 }), []);
  const audioSyncAnchorListeners = useRef8([]);
  const audioSyncAnchorEmitter = useMemo18(() => {
    return {
      dispatch: (event) => {
  ...
  const nodesToResume = useRef8(new Map);
  ...
  const audioContextValue = useMemo18(() => {
    return {
...
var SharedAudioTagsContextProvider = ({ children, numberOfAudioTags }) => {
  ...
  const env = useRemotionEnvironment();
  const audioCtx = useContext18(SharedAudioContext);
  ...
  const audioTagsValue = useMemo18(() => {
    return {
      registerAudio,
      unregisterAudio,
      updateAudio,
...
var useSharedAudio = ({
  ...
  const audioCtx = useContext18(SharedAudioContext);
  const tagsCtx = useContext18(SharedAudioTagsContext);
...
var AudioRefForwardingFunction = (props, ref) => {
  const audioTagsContext = useContext28(SharedAudioTagsContext);
  const {
    startFrom,
    endAt,
    trimBefore,
                ...
                children: /* @__PURE__ */ jsx27(DurationsContextProvider, {
                  children: /* @__PURE__ */ jsx27(BufferingProvider, {
                    children: /* @__PURE__ */ jsx27(SharedAudioContextProvider, {
                      audioLatencyHint,
                      audioEnabled,
                      children: /* @__PURE__ */ jsx27(SharedAudioTagsContextProvider, {
                        numberOfAudioTags,
                        children
                      })
                    })
